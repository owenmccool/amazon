...
nrow(snake.master[snake.master$Snake_ID != " ", ])
...
guild.summ.plot <- guild.summ %>%  
  ...
  xlab(NULL) + scale_x_discrete(labels = (c("Mixed diet", "Mostly mammals", "No mammals"))) +
...
#ggsave(plot = guild.summ.plot, file = "snakes_per_guild.jpg", height = 4, width = 7)
