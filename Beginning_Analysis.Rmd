...
df_snakes.sur2<- df_snakes.sur[-2, ] #removing blank row from dataset
df_snakes.sur[-2, ]
test <- df_snakes.sur[4, 3] 
rm(test) #removing object from workspace
colnames(df_snakes.sur2) <- df_snakes.sur2[1, ] #takes 1st row and makes it column names
df_snakes.sur2 <- df_snakes.sur2[-1, ] #removed extra row that originally had column names but were now useless
unique(df_snakes.sur2$Species)
