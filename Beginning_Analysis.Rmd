...
AbunP1 <- ggplot(trail.div, aes(y=n, x=Station)) +
  geom_boxplot()
AbunP1
...
sp.abun$st.tr.spp <- paste(sp.abun$Station, sp.abun$Trail_Walked, sp.abun$Species, sep = ".")
sp.abun.mat <- sp.abun %>% 
  pivot_wider(names_from = Species, 
              values_from = n, 
              values_fill = 0) %>%
  column_to_rownames(var = "st.tr.spp")
