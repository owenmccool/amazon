...
=======
```{r clean env after und}
rm(sim, und.mean.se, und.mod, under.hist)
>>>>>>> 506f7683e49c58dd5675e5e89b96e118b8ca96b2
```
...
# fit model 4, station + interaction term for station X diet type
...
density_estimates <- predict(stationXdiet_type, type = 'state', newdata=newdata, appendData = TRUE)
