...
snakes.sur.seg.list$encount_500m <- ((snakes.sur.seg.list$n)/(snakes.sur.seg.list$DISTANCE_M))*500
...
p1 <- ggplot(data = snakes.sur.seg.list, aes(x = Station, y = encount_500m, fill = Diet_Type)) + geom_boxplot() + theme_bw() + ylab("encounter rate (500m)")
