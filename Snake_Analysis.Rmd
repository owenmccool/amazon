...
horn.MDS <- metaMDS(diss.mat.horn) #performs NMDS using v egan package, scaling multiple dimensions into two (pairwise comparisons between each unique survey night)

stressplot(horn.MDS, autotransform = FALSE, weakties = TRUE, trymax = 100, maxit = 300, try = 40, k = 2)
